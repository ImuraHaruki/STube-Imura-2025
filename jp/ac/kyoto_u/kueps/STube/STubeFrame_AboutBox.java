...
public class STubeFrame_AboutBox
    extends JDialog
  ...
  String product = "S-Tube";
  String version = "1.0";
  String copyright = "Copyright (C) 2003 NARUSE, Hajime All rights reserved.";
  String comments = "Settling-Tube Grain-Size Analyzer";

  public STubeFrame_AboutBox(Frame parent) {
    super(parent);
  ...
  private void jbInit() throws Exception {
    image1 = new ImageIcon(jp.ac.kyoto_u.kueps.STube.STubeFrame.class.
